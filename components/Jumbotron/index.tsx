...
const Jumbotron = () => {
  return (
    <section className="ml-auto max-w-[1271px] flex items-center min-h-[700.05px] 
        bg-[url('/images/jumbotron-img.png')] bg-no-repeat"
    >
      <div className="mr-auto md:w-[1037px]">
        <div>
          <div className="flex flex-wrap items-end text-white">
            <h1 className="jumbotron-text">YOUR</h1>
            <p className="ml-8 jumbotron-content-text">CONTENT</p>
          </div>
        </div>
