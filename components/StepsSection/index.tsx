        ...
        <div className="md:mt-[117px] md:mb-[170.6px]">
          ...
          <div className="md:mt-[119px]">
            <div className="md:flex">
              <div className="text-white md:w-6/12 -mx-2 font-['Test_Söhne'] text-[40px] leading-[100%]">
                ...
                {/* <p className="text-[40px] leading-[100%] break-words">
                    from <br/>
                    <span className="text-[64px]">WEB2</span><br/>
                    to <br/>
                    <span className="text-[64px]">WEB3</span>
                  </p> */}
              </div>
              ...
              <div className="md:w-6/12">
                {steps &&
                  steps.map((curr) => {
                    return (
                      <div className="py-5 flex items-center text-['Test_Söhne'] text-[16px] leading-[100%] text-[#8F8F8F]">
                        <DefaultBullet />
